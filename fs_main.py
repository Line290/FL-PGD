...
from attack_methods import Attack_FeaScatter, Attack_Madry, Attack_nat, Attack_BAT
from GCE import GuidedComplementEntropy
...
config_GCE = {
    'train': True,
    'loss_func': GuidedComplementEntropy(alpha=0.2, classes=args.num_classes, reduce='none'),
}

if args.adv_mode.lower() == 'feature_scatter':
    print('-----Feature Scatter mode -----')
    net = Attack_FeaScatter(basic_net, config_feature_scatter)
elif args.adv_mode.lower() == 'bat':
    print('-----BAT mode -----')
    net = Attack_BAT(basic_net, config_bat)
elif args.adv_mode.lower() == 'natural':
    print('-----natural mode -----')
    net = Attack_nat(basic_net, config_nat)
elif args.adv_mode.lower() == 'madry':
    print('-----Madry mode -----')
    net = Attack_Madry(basic_net, config_madry)
elif args.adv_mode.lower() == 'gce':
    print('-----GCE mode -----')
    net = Attack_nat(basic_net, config_GCE)
else:
