...
for attack_idx in range(attack_num):
    ...
    if args.attack_method == 'natural':
    ...
    elif args.attack_method.upper() == 'PGD20':
        config_pgd = {
            'train': False,
            'targeted': False,
            'epsilon': 8.0 / 255 * 2,
        ...
        print('-----PGD20 adv mode -----')
        net = Attack_PGD(basic_net, config_pgd)
    elif args.attack_method.upper() == 'PGD100':
        print('-----PGD100 adv mode -----')
        config_pgd = {
            'train': False,
            'targeted': False,
            'epsilon': 8.0 / 255 * 2,
        ...
        net = Attack_PGD(basic_net, config_pgd)
    elif args.attack_method.upper() == 'CW20':
        print('-----CW20 adv mode -----')
        config_cw = {
            'train': False,
            'targeted': False,
    ...
    elif args.attack_method.upper() == 'CW100':
        config_cw = {
            'train': False,
            'targeted': False,
            'epsilon': 8.0 / 255 * 2,
    ...
    res_acc = test(0, net)
    res[args.attack_method] = res_acc
print(res)
