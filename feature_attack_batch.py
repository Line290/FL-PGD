...
parser.add_argument('--num_attack_step', default=20, type=int, help='attack step')
# dataset dependent
...
config_feature_attack = {
    'train': False,
    'epsilon': 8.0 / 255 * 2,
    'num_steps': args.num_attack_step,
    'step_size': 2.0 / 255 * 2,
    'random_start': True,
    'early_stop': True,
    'num_total_target_images': 100
}
...
for clean_idx in tqdm(range(2000)):
